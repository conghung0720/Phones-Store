...
const OrderHistory = () => {
    ...
    const {data: isData, isSuccess} = useGetOrderHistoryUserQuery({userId: userInfo?.account._id})
  return (
    <>
        <Header/>
        <main className='bg-gray-100 space-y-9 py-[5%] px-[19%] min-h-screen'>
            {
                isSuccess && isData?.map(value => (
                ...
                <div className='flex justify-between border-b-2 py-[2%]'>
                    <ul className='flex justify-around w-[50%]'>
                        <li>
                            ...
                            <span className='text-gray-500'>#{value._id.slice(0, 13)}</span>
                        </li>
                        <li>
                        ...
                        <h1 className='font-medium tracking-tight text-gray-900'>Tổng giá</h1>
                            <h4 className='font-medium'>{formattedPrice(value.total_price + 25000 + 25000)}</h4>
                        </li>
                    </ul>
