...
function NavbarCol () {
  return (
    <div>
      ...
      <aside id="sidebar-multi-level-sidebar" class="fixed shadow-lg top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto dark:bg-zinc-800">
            <ul class="space-y-2 font-medium">
              <li class="mb-10">
                <a href="https://flowbite.com/" class="flex items-center">
                <img src="https://flowbite.com/docs/images/logo.svg" class="h-12 ml-[5.5rem]" alt="Flowbite Logo" />
                </a>
              </li>
